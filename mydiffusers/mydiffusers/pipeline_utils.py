...
DUMMY_MODULES_FOLDER = "mydiffusers.utils"
...
class DiffusionPipeline(ConfigMixin):
    ...
    def register_modules(self, **kwargs):
        ...
        from mydiffusers import pipelines
    ...
    def save_pretrained(
        ...
        model_index_dict.pop("_mydiffusers_version")
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs):
        ...
        if pipeline_class.__name__ == "StableDiffusionInpaintPipeline" and version.parse(
            version.parse(config_dict["_mydiffusers_version"]).base_version
        ) <= version.parse("0.5.1"):
            from mydiffusers import StableDiffusionInpaintPipeline, StableDiffusionInpaintPipelineLegacy
        ...
        for name, (library_name, class_name) in init_dict.items():
            ...
            if loaded_sub_model is None:
                ...
                if issubclass(class_obj, mydiffusers.OnnxRuntimeModel):
                    loading_kwargs["provider"] = provider
                    loading_kwargs["sess_options"] = sess_options

                is_diffusers_model = issubclass(class_obj, mydiffusers.ModelMixin)
